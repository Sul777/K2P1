...
class FaceEnhancement(object):
    ...
    def __init__(self, base_dir='/content/drive/MyDrive/ColabNotebooks/Final/GraduationAssignment/GPEN/', size=512, model=None, channel_multiplier=2, narrow=1):
...
def Enhancement(indir, outdir, dataname):
  ...
  #----
  #model = {'name':'GPEN-512', 'size':512, 'channel_multiplier':2, 'narrow':1}
  model = {'name':'GPEN-BFR-256', 'size':256, 'channel_multiplier':1, 'narrow':0.5}
  #----
  ...
  filename = indir.split('Swappedimgs/')[1]
  # dataname = 'data5'
  # indir = '/content/drive/MyDrive/ColabNotebooks/Final/GraduationAssignment/Processeddata/data5/Swappedimgs/croppedImage224_0_result.jpg'
  # filename = croppedImage224_0_result.jpg
  print('filename : ', filename)
  
  im = cv2.imread(indir, cv2.IMREAD_COLOR) # BGR
...
if __name__=='__main__':
    ...
    #----
    #indir = '/content/drive/MyDrive/ColabNotebooks/Final/Final_ing_mine/Swappedimgs/data30/'
    #outdir = '/content/drive/MyDrive/ColabNotebooks/Final/Final_ing_mine/Swappedimgs/data30/'
    #----

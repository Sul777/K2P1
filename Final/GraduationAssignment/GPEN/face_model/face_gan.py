...
class FaceGAN(object):
    ...
    def __init__(self, base_dir='/content/drive/MyDrive/ColabNotebooks/Final/GraduationAssignment/GPEN/', size=512, model=None, channel_multiplier=2, narrow=1, is_norm=True):

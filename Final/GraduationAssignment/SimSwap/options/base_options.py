...
class BaseOptions():
    ...
    def initialize(self):
        ...
        #----
        self.parser.add_argument('--checkpoints_dir', type=str, default='/content/drive/MyDrive/ColabNotebooks/Final/GraduationAssignment/SimSwap/checkpoints', help='models are saved here')
        #----

...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        #----
        self.parser.add_argument("--Arc_path", type=str, default='/content/drive/MyDrive/ColabNotebooks/Final/GraduationAssignment/SimSwap/arcface_model/arcface_checkpoint.tar', help="run ONNX model via TRT")
        #----
        ...
        #----
        self.parser.add_argument("--output_path", type=str, default='/content/drive/MyDrive/ColabNotebooks/Final/GraduationAssignment/Processeddata/', help="results path")
        #----
